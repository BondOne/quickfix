...
namespace FIX
{
  namespace FIELD
  {
    ...
    const int BenchmarkSecurityDesc = 6632;
    const int LegDV01 = 22041;
    const int SpreadType = 22048;
    const int LegNotionalNeutral = 22049;
    const int PriceScalingFactor = 22050;
    const int VolumeScalingFactor = 22051;
    const int SetupMonitorRequestID = 22056;
    const int NoMonitorIDs = 22057;
    const int MonitorID = 22058;
    const int ClearMonitorIndicator = 22059;
    const int MonitorSortOption = 22060;
    const int MonitorNumber = 22061;
    const int MonitorPageNumber = 22062;
    const int NoMonitorRows = 22063;
    const int RowNumber = 22064;
    const int RowLoadAction = 22065;
    const int RowForegroundColor = 22066;
    const int SecurityIDSourceOverride = 22067;
    const int SuppressPricesIndicator = 22068;
    const int SetupMonitorRequestStatus = 22069;
  }
}
